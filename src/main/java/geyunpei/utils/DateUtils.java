...
public class DateUtils {
	...
	public static Integer getMonthSpace(String nowDate, String endDate) {
		if (endDate == null || "".equals(endDate) || nowDate == null
				|| "".equals(nowDate)) {
			return null;
		}
		try {
	...
	public static void main(String[] args) {
		// long str = dateDiff("2015-5-28 10:26:30", new
		// SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
		System.out.println(getStrDate());
		// System.out.println(getRandom(7));
		// try {
		// int aa= getMonthSpace("2014-11-15","2017-05-03");
		// System.out.println(aa);
		// } catch (Exception e) {
		// e.printStackTrace();
		// }

		// System.out.println(getNextDay("2014-1-1","180"));
	}
